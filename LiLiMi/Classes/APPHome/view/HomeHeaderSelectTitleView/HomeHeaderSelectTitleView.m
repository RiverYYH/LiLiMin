...
@interface HomeHeaderSelectTitleView()
{
    NSInteger index;
}
...
@implementation HomeHeaderSelectTitleView
                       ...
                       images:(NSArray *)imageArray
{
    if (self = [super initWithFrame:frame]) {
        ...
        for (int i = 0; i < titleArray.count; i ++) {
            HomeHeaderTitleButton *button = [HomeHeaderTitleButton buttonWithType:UIButtonTypeCustom];
            [button setTitle:titleArray[i] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:imageArray[i]] forState:UIControlStateNormal];
            button.titleLabel.font = self.titleFont?self.titleFont:setFont(10);
...
- (void)layoutSubviews
{
    ...
    for(int i = 0 ; i <self.buttonArray.count ; i++)
    {
        ...
        btn.frame = CGRectMake((14 + 124 * i)* ADAPTIVE_PROPORTION, 0, 116 * ADAPTIVE_PROPORTION, 116 * ADAPTIVE_PROPORTION);
    ...
    rect.origin.y = 129 * ADAPTIVE_PROPORTION;
    rect.size.height = 5 * ADAPTIVE_PROPORTION;
