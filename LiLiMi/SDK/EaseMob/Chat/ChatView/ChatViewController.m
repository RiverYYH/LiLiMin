...
@interface ChatViewController ()<UIAlertViewDelegate, EaseMessageViewControllerDelegate, EaseMessageViewControllerDataSource,EMClientDelegate,UIActionSheetDelegate,UIActionSheetDelegate>
{
...
{
    APPLog(@"右上角按钮");
    UIActionSheet *sheet = [[UIActionSheet alloc]initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"加入黑名单",@"举报", nil];
...
//    [self.navigationItem setLeftBarButtonItem:backItem];
    ...
    [clearButton addTarget:self action:@selector(clickMoreButton:) forControlEvents:UIControlEventTouchUpInside];
