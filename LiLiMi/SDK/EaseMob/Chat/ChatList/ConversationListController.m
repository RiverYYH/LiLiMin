...
- (void)viewDidLoad {
    ...
    //添加右上角按钮
    self.navigationItem.rightBarButtonItem=[UIBarButtonItem setBarButtonItemImage:[UIImage imageNamed:@"user@2x.png"] highlightedImage:nil title:nil titlecolor:nil target:self action:@selector(gotoFriendsVC) isleftbtn:NO down:NO showred:NO];
}
...
//点击跳转界面的
-(void)notiListViewController:(EaseConversationListViewController *)conversationListViewController didSelectConversationModel:(NotiListModel *)conversationModel
{
    if (conversationModel) {
        APPLog(@"点击系统消息");
    }
