...
- (void)_setupTimeLabelConstraints
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.timeLabel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeHeight multiplier:0.4 constant:0]];
}
...
#pragma mark - Update Constraint(设置头像圆)
...
- (void)setAvatarCornerRadius:(CGFloat)avatarCornerRadius
{
    ...
    if (self.avatarView){
        [self.avatarView setImageCornerRadius:20.0];
    }
}
